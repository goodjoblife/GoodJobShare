...
import styles from './WorkExperiencesGender.module.css';
        ...
        <div className={styles.distribution}>
          <ResponsiveContainer>
            <BarChart data={rows} layout="vertical">
              <XAxis hide type="number" height={70} />
              <YAxis type="category" dataKey="rating" unit="分" />
              <Bar dataKey="count" fill="#fcd406" label />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
        ...
        {FILTER_OPTIONS.map(option => {
          ...
          return (
            ...
            >
              ...
              >
                {isActive && <span className={styles.checkboxCheck} />}
              </span>
              {option.label}
            </button>
          );
