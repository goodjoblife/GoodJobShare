...
export const salaryWorkTimeStatistics: (box: FetchBox<unknown>) => unknown =
  R.pipe(
    state => state.data,
...
export const companyIndexesBoxSelectorAtPage =
  (page: number) =>
  (state: RootState): FetchBox<CompanyInIndex[]> =>
...
export const companyOverviewBoxSelectorByName =
  (companyName: string) =>
...
export const companyTimeAndSalaryBoxSelectorByName =
  (companyName: string) =>
  (state: RootState): FetchBox<CompanyTimeAndSalaryResult | null> =>
...
export const companyTopNJobTitlesBoxSelectorByName =
  (companyName: string) =>
  (state: RootState): FetchBox<TopNJobTitles | null> =>
    state.companyIndex.topNJobTitlesByName[companyName] || getUnfetched();

export const companyEsgSalaryDataBoxSelectorByName =
  (companyName: string) =>
  (state: RootState): FetchBox<ESGSalaryData | null> =>
...
export const companyIsSubscribedBoxSelectorByName =
  (companyName: string) =>
  (state: RootState): FetchBox<CompanyIsSubscribed | null> =>
    state.companyIndex.isSubscribedByName[companyName] || getUnfetched();

export const jobTitleIndexesBoxSelectorAtPage =
  (page: number) =>
  (state: RootState): FetchBox<JobTitleInIndex[]> =>
...
export const jobTitleOverviewBoxSelectorByName =
  (jobTitle: string) =>
...
export const jobTitleTimeAndSalaryBoxSelectorByName =
  (jobTitle: string) =>
  (state: RootState): FetchBox<JobTitleTimeAndSalaryResult | null> =>
...
export const jobTitleWorkExperiencesBoxSelectorByName =
  (jobTitle: string) =>
  (state: RootState): FetchBox<JobTitleWorkExperienceResult | null> =>
